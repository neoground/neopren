...
export default class Pagination extends Component {
    ...
    renderPaginationItem = (props, state, context) => {
        ...
        return html`
            <li class=${classname}><a class="page-link" href="#" data-page=${props.page}
                                      onclick=${this.goToPage}>${props.page}</a></li>
        `
    }
    ...
    PaginationItems = (props, state, context) => {
        ...
        if (last_page < 10) {
            return html`
                ...
                ${last_page >= 5 && html`
                    <${this.renderPaginationItem} page="5" current_page=${current_page}/>`}
                ${last_page >= 6 && html`
                    <${this.renderPaginationItem} page="6" current_page=${current_page}/>`}
                ${last_page >= 7 && html`
                    <${this.renderPaginationItem} page="7" current_page=${current_page}/>`}
                ${last_page >= 8 && html`
                    <${this.renderPaginationItem} page="8" current_page=${current_page}/>`}
                ${last_page >= 9 && html`
                    <${this.renderPaginationItem} page="9" current_page=${current_page}/>`}
        ...
        if (current_page <= (first_page + 3) || current_page >= (last_page - 3)) {
            ...
            return html`
                ...
                ${show_additional && html`
                    <${this.renderPaginationItem} page=${last_page - 4} current_page=${current_page}/>`}
