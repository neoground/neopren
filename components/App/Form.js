...
export default class Form {
    static Input = (props, state, context) => {
        ...
        return html`
            <input type=${type} class="form-control" id=${"input-" + props.name} name=${props.name} value=${props.value} onInput=${changehandler} ...${params} />
        `
    }
    ...
    static Textarea = (props, state, context) => {
        ...
        return html`
            <textarea class="form-control" id=${"input-" + props.name} name=${props.name} rows=${rows} value=${props.value} onInput=${props.change} ...${params} />
        `
    }
